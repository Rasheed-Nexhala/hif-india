...
export const HIF_PROJECTS: ProjectData[] = [
  {
    ...
    beforeImages: [
      ...
      '/images/gallery/ashiyana-before-laterite-tarp-shack.jpg',
      '/images/gallery/ashiyana-before-old-tiled-cottage.jpg',
    ...
    afterImages: [
      ...
      '/images/projects/ashiyana3.jpg',
      '/images/gallery/ashiyana-after-cream-home-stairs.jpg',
...
export const HIF_GALLERY: GalleryItem[] = [
  ...
  {
    id: 'gal-58',
    title: 'Ashiyana Before - Weathered House Visit',
    category: 'Housing',
    imageUrl: '/images/gallery/ashiyana-house-construction-2013.jpg',
    location: 'Karnataka',
    description: 'HIF team members inspect a stained, unfinished dwelling identified for Project Ashiyana support.',
    year: '2013'
  },
  {
    id: 'gal-59',
    title: 'Ashiyana Before - Laterite Shack Visit',
    category: 'Housing',
    imageUrl: '/images/gallery/ashiyana-home-handover-2016.jpg',
    location: 'Karnataka',
    description: 'HIF volunteers walk toward a laterite brick shack with clothes hung to dry, documented before Ashiyana construction.',
    year: '2016'
  },
  {
    id: 'gal-60',
  ...
  {
    id: 'gal-115',
    title: 'Ashiyana Before - Laterite Tarp Shack',
    category: 'Housing',
    imageUrl: '/images/gallery/ashiyana-before-laterite-tarp-shack.jpg',
    location: 'Karnataka',
    description: 'A laterite-brick shack with a blue tarpaulin roof and plastic-covered window, documented before Ashiyana construction.',
    year: '2016'
  },
  {
    id: 'gal-116',
    title: 'Ashiyana Before - Old Tiled Cottage',
    category: 'Housing',
    imageUrl: '/images/gallery/ashiyana-before-old-tiled-cottage.jpg',
    location: 'Karnataka',
    description: 'An ageing tiled cottage with laundry on the verandah, surveyed for Project Ashiyana support.',
    year: '2016'
  },
  {
    id: 'gal-117',
    title: 'Ashiyana Before - Makeshift Tarp Camp',
    category: 'Housing',
    imageUrl: '/images/projects/ashiyana9.jpg',
    location: 'Karnataka',
    description: 'A shelter pieced together from tarpaulin, sacks, and scrap boards, the kind of dwelling Project Ashiyana replaces.',
    year: '2016'
  },
  {
    id: 'gal-118',
    title: 'Ashiyana After - Cream Home with Stairs',
    category: 'Housing',
    imageUrl: '/images/gallery/ashiyana-after-cream-home-stairs.jpg',
    location: 'Karnataka',
    description: 'A completed Ashiyana pucca home with a covered porch, terrace stairs, and plastered walls.',
    year: '2024'
  },
  {
    id: 'gal-119',
    title: 'Ashiyana After - White and Blue Home',
    category: 'Housing',
    imageUrl: '/images/projects/ashiyana3.jpg',
    location: 'Karnataka',
  ...
  {
    id: 'gal-1',
    title: 'Free Quran Distribution Counter',
    category: 'Community',
    imageUrl: '/images/gallery/1.jpg',
    location: 'Mangalore Municipal Council',
    description: 'HIF volunteers distribute free copies of the Quran to community members at a public counter inside the Mangalore Municipal Council building.',
    year: '2019'
  },
  {
    id: 'gal-2',
    title: 'Ashiyana Home Handover Gathering',
    category: 'Housing',
    imageUrl: '/images/gallery/2.jpeg',
    location: 'Karnataka',
    description: 'HIF volunteers and community members gather on the porch of a newly completed Ashiyana home, with gift packages presented to the beneficiary family.',
    year: '2016'
  },
  {
    id: 'gal-3',
    title: 'Water Tank Delivery to Household',
    category: 'Community',
    imageUrl: '/images/gallery/3.jpg',
    location: 'Mangaluru Region',
    description: 'HIF volunteers deliver and install a large water storage tank on a truck for a residential family facing water scarcity.',
    year: '2016'
  },
  {
    id: 'gal-4',
    title: 'HIF INSPIRE Leadership Workshop',
    category: 'Youth',
    imageUrl: '/images/gallery/4.jpg',
    location: 'HIF Center, Mangaluru',
    description: 'HIF Youth Wing members lead an INSPIRE leadership and management workshop with team activities and audience assignments.',
    year: '2024'
  },
  {
    id: 'gal-5',
    title: 'Youth Sports Day Celebration',
    category: 'Youth',
    imageUrl: '/images/gallery/5.jpg',
    location: 'Mangaluru',
    description: 'Young boys celebrate at a youth sports day event with medals and a balloon-blowing competition in an outdoor courtyard.',
    year: '2024'
  },
  {
    id: 'gal-6',
    title: 'Community Medical Checkup Camp',
    category: 'Healthcare',
    imageUrl: '/images/gallery/6.jpg',
    location: 'Mangaluru',
    description: 'A patient receives medical attention in a clinic ward with blood pressure monitoring and medical supplies on hand.',
    year: '2024'
  },
  {
    id: 'gal-7',
    ...
    location: 'Mangaluru',
    description: 'HIF volunteers distribute bags of essential goods to a young beneficiary inside a community distribution room.',
    year: '2024'
  },
  {
    id: 'gal-8',
    title: 'Free Training Valedictory Ceremony',
    category: 'Education',
    imageUrl: '/images/gallery/8.jpg',
    location: 'Mangaluru',
    description: 'Certificate presentation at the valedictory ceremony for free spoken English and computer training for needy students.',
    year: '2024'
  },
  {
    id: 'gal-9',
    ...
    location: 'Rural Karnataka',
    description: 'Community members gather outdoors holding a hand-written "HOPE" sign, reflecting resilience and solidarity.',
    year: '2018'
  },
  {
    id: 'gal-10',
    title: 'Youth Balloon Race Games',
    category: 'Youth',
    imageUrl: '/images/gallery/10.jpg',
    location: 'Mangaluru',
    description: 'Young boys in traditional attire compete in a balloon-balancing race under an outdoor canopy at a youth activity day.',
    year: '2024'
  },
  {
    id: 'gal-11',
    title: 'HIF Student Wing Closing Ceremony',
    category: 'Education',
    imageUrl: '/images/gallery/11.jpg',
    location: 'Edutech Tutorials, Deralakatte',
    description: 'Certificate handover at the HIF Student Wing closing ceremony in association with Edutech Tutorials.',
    year: '2015'
  },
  {
    id: 'gal-12',
    title: 'Kerala Flood Relief to Wayanad',
    category: 'Community',
    imageUrl: '/images/gallery/12.jpg',
    location: 'Wayanad, Kerala',
    description: 'HIF volunteers pose with a relief truck before deploying flood aid supplies to families affected in Wayanad.',
    year: '2018'
  },
  {
    id: 'gal-13',
    title: 'HIF Journalist Get-Together 2019',
    category: 'Community',
    imageUrl: '/images/gallery/13.jpg',
    location: 'Mangaluru Press Club, Urwa',
    description: 'HIF Mangaluru team members at a journalist get-together held at the Mangaluru Press Club on 16 December 2019.',
    year: '2019'
  },
  {
    id: 'gal-14',
    ...
    location: 'Mangaluru',
    description: 'Youth and community members watch an outdoor volleyball match on a clay court in a neighbourhood setting.',
    year: '2024'
  },
  {
    id: 'gal-15',
    title: 'Certificate of Achievement Awards',
    category: 'Education',
    imageUrl: '/images/gallery/15.jpg',
    location: 'Mangaluru',
    description: 'Students and graduates pose with certificates of achievement and plaques at a formal HIF awards ceremony.',
    year: '2024'
  },
  {
    id: 'gal-16',
    title: 'Masjid Community Group Photo',
    category: 'Masjid',
    imageUrl: '/images/gallery/16.jpg',
    location: 'Karnataka',
    description: 'Community members and volunteers gather for a group photo at a masjid entrance with characteristic Islamic architecture.',
    year: '2024'
  },
  {
    id: 'gal-17',
    title: 'HIF India Ambulance Inauguration',
    category: 'Healthcare',
    imageUrl: '/images/gallery/17.jpg',
    location: 'Masjid Ul Umar, Mangaluru',
    description: 'Inauguration ceremony for a new HIF India ambulance, with community leaders seated before the covered vehicle.',
    year: '2024'
  },
  {
    id: 'gal-19',
